...
<body>
    ...
    <body>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input id="input_phonenumber" type="tel" placeholder="Enter your phone number" name="phoneNumber">
                </p>
        ...
        <div style="width:150px; height: 50px">
            <button style="width:100%; height:100%; background:navajowhite; border-radius:2px; margin:0px;">
                <a style="border: 0px; background:transparent; text-decoration: none; color: black; font-size: 30px; text-align:center; font-family:cambria" href="login-form.php">Login</a>
            </button>
        </div>
